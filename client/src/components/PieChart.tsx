      ...
      <div className="flex justify-between items-start w-full">
        ...
        >
          ...
          <div className="p-2">
            <button
              type="button"
              className="inline-block w-full py-2 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 rounded-lg"
            >
              Apply date range
            </button>
          </div>
