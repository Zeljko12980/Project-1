...
export default function LineChart() {
  ...
  return (
    <div className="max-w-[1290px]  w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 flex flex-col m-10">
      ...
      <div id="line-chart" className="w-full mx-auto"></div>
